...
function random_dir_choose() {
	...
	var _new_dir = point_direction(x, y, room_mid_x(), room_mid_y());
...
function lerp_towards_random_dir_target(){
    ...
    direction = direction - _angle_dif * (delta_time / 1000000) * (2 + get_fluctuation()) * (point_distance(x, y, room_mid_x(), room_mid_y()) / 128);
}
